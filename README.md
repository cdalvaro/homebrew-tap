...
|[salt](Formula/salt.rb)|[SaltStack/salt](https://github.com/saltstack) Software to automate the management and configuration of any infrastructure or application at scale. (Salt Sodium v3001 with Python 3.7)|
